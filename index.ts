 ...
 */
app.post("/admin/generate-token", async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    await db.saveToken(token, email, allowedRequests, expiresAt.toISOString());
    res.json({
      success: true,
      token,
 ...
 */
app.post("/admin/tokens", async (req: Request, res: Response): Promise<void> => {
 ...
 */
app.get("/validate-token", authenticateToken, async (req: AuthRequest, res: Response): Promise<void> => {
 ...
 */
app.post("/tiktok", authenticateToken, async (req: AuthRequest, res: Response): Promise<void> => {
